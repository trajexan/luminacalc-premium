import { r as reactExports, V as jsxRuntimeExports } from "./server-QQkYV8jP.js";
...
const variantClasses = {
  default: "glass text-foreground hover:bg-white/40 dark:hover:bg-white/10",
  function: "glass text-accent-foreground bg-accent/30 hover:bg-accent/50 text-accent",
  operator: "text-primary-foreground gradient-primary shadow-glow hover:brightness-110",
  equals: "text-primary-foreground gradient-primary shadow-glow hover:brightness-110"
};
function CalcButton({ children, onClick, variant = "default", className, ariaLabel }) {
...
function HistoryPanel({ history, onSelect, onClear }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-5 shadow-soft h-full flex flex-col min-h-[300px] lg:min-h-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(History, { className: "h-4 w-4 text-muted-foreground" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold tracking-wide uppercase text-muted-foreground", children: "History" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto -mx-2 px-2", children: history.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center text-center text-sm text-muted-foreground/70 py-12", children: "Your calculations will appear here" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: history.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.li,
      {
        layout: true,
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground truncate group-hover:text-foreground/70", children: entry.expression }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-lg font-semibold gradient-text truncate", children: [
                "= ",
                entry.result
              ] })
            ]
...
function Calculator() {
  ...
  expr.slice(-1);
  const inputDigit = reactExports.useCallback((d) => {
    setExpr((prev) => {
      if (justEvaluated) {
      ...
      if (d === ".") {
        const tokens2 = prev.split(/[+\-−×÷%]/);
        const current = tokens2[tokens2.length - 1];
  ...
  const inputOperator = reactExports.useCallback((op) => {
    setJustEvaluated(false);
    setExpr((prev) => {
      if (prev === "" && op === "−") return "−";
      if (prev === "") return prev;
  ...
  const equals = reactExports.useCallback(() => {
    if (!expr) return;
    try {
  ...
  const applyUnary = reactExports.useCallback((fn, label) => {
    try {
  ...
  const expressionPreview = reactExports.useMemo(() => {
    return justEvaluated ? "" : expr || "";
  }, [expr, justEvaluated]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen w-full px-4 py-6 sm:py-10 flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "max-w-6xl mx-auto w-full flex items-center justify-between mb-6 sm:mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-10 rounded-2xl gradient-primary shadow-glow flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-5 w-5 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-xl sm:text-2xl font-semibold tracking-tight", children: [
            "Lumina",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Calc" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground hidden sm:block", children: "A premium calculator experience" })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-5 sm:p-7 shadow-soft", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-background/30 dark:bg-black/20 p-5 mb-5 min-h-[140px] flex flex-col justify-end", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right text-sm text-muted-foreground h-6 truncate", children: expressionPreview }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-end gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: copy,
                ...
                children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4 text-accent" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-4 w-4" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-2 sm:gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "function", onClick: clearAll, children: "AC" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "function", onClick: clearEntry, children: "C" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "function", onClick: percent2, children: "%" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "operator", onClick: () => inputOperator("÷"), children: "÷" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "function", onClick: square, ariaLabel: "square", children: "x²" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "function", onClick: sqrt, ariaLabel: "square root", children: "√" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "function", onClick: toggleSign, ariaLabel: "toggle sign", children: "±" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "operator", onClick: () => inputOperator("×"), children: "×" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("7"), children: "7" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("8"), children: "8" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("9"), children: "9" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "operator", onClick: () => inputOperator("−"), children: "−" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("4"), children: "4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("5"), children: "5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("6"), children: "6" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "operator", onClick: () => inputOperator("+"), children: "+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("1"), children: "1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("2"), children: "2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("3"), children: "3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "equals", onClick: equals, children: "=" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("0"), className: "col-span-2", children: "0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { onClick: () => inputDigit("."), children: "." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalcButton, { variant: "function", onClick: backspace, ariaLabel: "backspace", children: "⌫" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        HistoryPanel,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "max-w-6xl mx-auto w-full mt-6 text-center text-xs text-muted-foreground", children: "Tip: use your keyboard — numbers, + − * /, Enter, Backspace, Esc" })
  ] });
}
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, {});
}
export {
  Index as component
};
